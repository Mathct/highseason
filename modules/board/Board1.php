...
class Board1 extends Board
{
    ...
    public function argPorte8($parg1, $parg2)
    {
        ...
        foreach ($porteadajacente as $porte)
        {
            ...
            if (($prix <= $this->player_money )&&($couleur==2))
            {
    ...
    public function Porte8($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {
            highseason::$instance->addPendingTarget($this->player_id, "Board".$this->player_hotel, 'Porte8', 8);
    ...
    public function Porte20($parg1, $parg2, $varg1, $varg2)
    {
        ...
        elseif (strpos($varg1, "credit") === 0)
        {
            highseason::$instance->addPendingTarget($this->player_id, "Board".$this->player_hotel, 'Porte20', 20);
            highseason::$instance->addPending($this->player_id, "Credit");
    ...
    public function Porte24($parg1, $parg2, $varg1, $varg2)
    {
        ...
        elseif (strpos($varg1, "credit") === 0)
        {
            highseason::$instance->addPendingTarget($this->player_id, "Board".$this->player_hotel, 'Porte24', 24);
            highseason::$instance->addPending($this->player_id, "Credit");
    ...
    public function Porte25($parg1, $parg2, $varg1, $varg2)
    {
        ...
        elseif (strpos($varg1, "credit") === 0)
        {
            highseason::$instance->addPendingTarget($this->player_id, "Board".$this->player_hotel, 'Porte25', 25);
            highseason::$instance->addPending($this->player_id, "Credit");
    ...
    public function Porte26($parg1, $parg2, $varg1, $varg2)
    {
        ...
        elseif (strpos($varg1, "credit") === 0)
        {
            highseason::$instance->addPendingTarget($this->player_id, "Board".$this->player_hotel, 'Porte26', 26);
            highseason::$instance->addPending($this->player_id, "Credit");
    ...
    public function Porte27($parg1, $parg2, $varg1, $varg2)
    {
        ...
        elseif (strpos($varg1, "credit") === 0)
        {
            highseason::$instance->addPendingTarget($this->player_id, "Board".$this->player_hotel, 'Porte27', 27);
            highseason::$instance->addPending($this->player_id, "Credit");
